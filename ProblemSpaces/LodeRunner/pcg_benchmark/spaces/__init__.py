try:
    ...
    from ProblemSpaces.LodeRunner.pcg_benchmark.spaces.float import FloatSpace
    from ProblemSpaces.LodeRunner.pcg_benchmark.spaces.integer import IntegerSpace
    from ProblemSpaces.LodeRunner.pcg_benchmark.spaces.array import ArraySpace
    from ProblemSpaces.LodeRunner.pcg_benchmark.spaces.generic import GenericSpace
    from ProblemSpaces.LodeRunner.pcg_benchmark.spaces.dictionary import DictionarySpace
import copy
import numpy as np
