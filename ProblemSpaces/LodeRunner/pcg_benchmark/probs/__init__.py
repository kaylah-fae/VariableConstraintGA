...
try:
    ...
    from ProblemSpaces.LodeRunner.pcg_benchmark.probs.problem import Problem
    string = "ProblemSpaces.LodeRunner."
...
for module_name in folders:
    module = import_module(f"{string}pcg_benchmark.probs.{module_name}")
