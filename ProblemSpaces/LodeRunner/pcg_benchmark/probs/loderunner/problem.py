try: 
    ...
    from ProblemSpaces.LodeRunner.pcg_benchmark.probs import Problem
    from ProblemSpaces.LodeRunner.pcg_benchmark.spaces import DictionarySpace, ArraySpace, IntegerSpace
    from ProblemSpaces.LodeRunner.pcg_benchmark.probs.loderunner.utils import play_loderunner, read_loderunner, js_dist
    from ProblemSpaces.LodeRunner.pcg_benchmark.probs.utils import get_num_tiles, _get_certain_tiles, get_number_regions, get_vert_histogram, get_horz_histogram, get_range_reward
import numpy as np
import os
